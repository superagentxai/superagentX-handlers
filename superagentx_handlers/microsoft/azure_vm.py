...
# Custom exceptions
class AzureVMListFailed(Exception): pass
class AzureVMClientInitFailed(Exception): pass
        ...
        try:
            async for vm in self.compute_client.virtual_machines.list_all():
                ...
                vms.append({
                    ...
                    "osType": str(vm.storage_profile.os_disk.os_type) if vm.storage_profile and vm.storage_profile.os_disk else None,
            ...
            raise AzureVMListFailed(f"Failed to list VMs: {e}")

...
'''
 Run Pytest:  
   ...
   1. pytest --log-cli-level=INFO tests/pipe/test_gcp_pipe_security_roles.py::TestPipeGCPSecurityInfo::test_pipe_gcp_security_roles
'''
...
class TestPipeGCPSecurityInfo:
    ...
    async def test_pipe_gcp_security_roles(self, agent_client_init: dict):
        ...
        security_roles_handler = GcpSecurityRoleHandler()
